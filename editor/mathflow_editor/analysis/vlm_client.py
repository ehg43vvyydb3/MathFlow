...
BLOCK_TYPES = ["text", "figure", "formula", "table", "problem_number", "page_number"]
...
- formula: 설명 문장 없이 수식 자체가 여러 줄에 걸쳐 나열된 것
  (예: "AB²=AC²+BC² \n =|x2-x1|²+|y2-y1|² \n ∴ AB=√(...)")
- table: 표
- problem_number: 문제 바로 앞/옆에 붙어 문제 목록 중간에 나오는 문제 번호 라벨
  (예: "26", "(1)")
- page_number: 문제 목록과 안 붙어 있고, 페이지 맨 위나 맨 아래 여백에 혼자
  떨어져 있는 쪽 번호 (예: "12", "013")
